This is a simple hello world lambda function writen with quarkus. We use quarkus to compile the java lambda function to native image, and package the native image into custom runtime. 
